...
const phoneScreenImage = document.getElementById('phoneScreenImage');

if (featureTabs.length > 0 && phoneScreenImage) {
    // Map screen types to image files
    const screenImages = {
        home: 'assets/mobile_mockup/Pets.png',
    ...
    featureTabs.forEach(tab => {
        tab.addEventListener('click', function() {
            ...
            const imagePath = screenImages[screenType] || screenImages.home;
            
            // Fade out animation
            phoneScreenImage.style.opacity = '0';
            phoneScreenImage.style.transform = 'scale(0.95)';
            
            // Change image after fade out
            setTimeout(() => {
                phoneScreenImage.src = imagePath;
                
                // Fade in animation
                setTimeout(() => {
                    phoneScreenImage.style.opacity = '1';
                    phoneScreenImage.style.transform = 'scale(1)';
                }, 50);
            }, 200);
        });
    });
    
    // Add smooth transition to phone screen image
    phoneScreenImage.style.transition = 'opacity 0.3s ease, transform 0.3s ease';
}
